...
HIT VARCHAR2(1 BYTE),
MEM_ID VARCHAR2(3O BYTE) NOT NULL
);
...
ALTER TABLE BOARD_T MODIFY CONTENTS VARCHAR2(4000 BYTE) NULL;
...
ALTER TABLE BOARD_T ADD CONSTRAINT FK_BOARD_MEMBER FOREIGN KEY(MEM_ID) REFERENCES MEMBER_T(MEM_ID);
